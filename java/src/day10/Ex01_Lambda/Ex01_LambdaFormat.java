...
public class Ex01_LambdaFormat {
	...
	public static void main(String[] args) {
		// 매개변수 X, 반환타입 X 람다식
		// () -> { System.out.println("") }
		// () -> { System.out.println("") } * 한문장이면 중괄호 생략 가능
		...
		// 매개변수 O, 반환타입 O 람다식
		FuncInterface4 fi4 = (a, b) -> {
			return a + b;
		};
		// (오류코드) FuncInterface4 fi5 = (a, b) -> return a + b;
		// return 문만 있을 경우엔 중괄호 생략 불가
		FuncInterface4 fi6 = (a, b) -> a + b;
		// 반환값만 있을 땐 return 중괄호 둘 다 생략해야 함
		// ㄴ 중괄호를 생략할시, return도 반드시 생략해야 함
