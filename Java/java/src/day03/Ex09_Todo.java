 ...
 * 메뉴를 통해 할 일을 추가, 조회, 상태변경 할 수 있는 기능을 구현
 * 
 * 기능
 * → 할 일 추가
 * → 할 일 목록
		...
		while( true ) {
			...
			switch (menuNo) {
				case 1:	// 할 일 추가
						...
						Todo todo = new Todo(name, Status.TODO);	// 할 일 객체 생성
						todoList[count++] = todo;						// 할 일 추가
						// count++;									// 할 일 개수 증가
				...
				case 3: // 상태 변경
					...
					todoList[index].setStatus( updateStatus );		// 지정한 할 일의 상태를 변경
