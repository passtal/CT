...
public class SimpleDateFormatEx {
	...
	public static void main(String[] args) throws ParseException {
		/*
		 * 날짜 패턴 기호 yyyy : 4자리 연도, yy : 2자리 연도 MM : 2자리 월, M : 1자리 월 dd : 2자리 일, d : 1자리
		 * 일 D : 올해의 몇 번째 일 w : 올해의 몇 주차 W : 이번 달의 몇 주차 E : 요일 a : 오전/오후 HH : 시(24시) hh
		 * : 시(12시) mm : 분 ss : 초
		 */
		...
		System.out.println(sdf.format(date)); // Date --> "2025/10/29"
